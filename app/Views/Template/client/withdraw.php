...
<head>
    <title>Faire un retrait - MobiCash</title>
    <meta charset="UTF-8">
...
<body data-role="client" data-page="withdraw">
    <div id="sidebar"></div>
    <div class="main">
        <div id="topbar"></div>
        <main class="content">
            <div class="mb-4">
                ...
                <p class="subtitle">Le système calcule automatiquement les frais.</p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-7">
                    <div class="cardx pad">
                        <form method="POST" action="/retrait/executer">
                            <?= csrf_field() ?>
                            <div class="mb-3">
