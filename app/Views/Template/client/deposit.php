...
<head>
    <title>Faire un dépôt - MobiCash</title>
    <meta charset="UTF-8">
...
<body data-role="client" data-page="deposit">
    <div id="sidebar"></div>
    <div class="main">
        <div id="topbar"></div>
        <main class="content">
            <div class="mb-4">
                <h1 class="title">Faire un dépôt</h1>
                <p class="subtitle">Ajoutez de l'argent à votre compte.</p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-7">
                    <div class="cardx pad">
                        <form method="POST" action="/depot/executer">
                            <?= csrf_field() ?>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary w-100 py-3">
                                <i class="bi bi-wallet2 me-2"></i>Confirmer le dépôt
                            </button>
                        </form>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="cardx pad">
                        <h2 class="h5 fw-bold">Informations</h2>
