            ...
            <div class="cardx pad mb-4">
                ...
                <form method="POST" action="/operator/operations/add" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="code" class="form-control" placeholder="Ex: DEPOT" required>
                    </div>
                    <div class="col-md-5">
                        <label class="form-label">Libellé</label>
                        <input name="libelle" class="form-control" placeholder="Ex: Dépôt" required>
                    </div>
            ...
            <div class="cardx pad">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php if (empty($types)): ?>
                                <tr><td colspan="4" class="text-center text-muted py-4">Aucun type d'opération.</td></tr>
                            <?php else: ?>
                                <?php foreach ($types as $t): ?>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="/operator/operations/toggle/<?= $t['id'] ?>" class="btn btn-sm btn-outline-secondary">
