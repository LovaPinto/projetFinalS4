...
class BaremesFrais extends Seeder
{
    public function run()
    {
        ...
        $data = [
            ...
            ['type_operation_id' => 3, 'operateur_id' => null, 'montant_min' => 100,   'montant_max' => 10000,  'frais' => 100, 'actif' => 1, 'date_debut' => $now, 'date_fin' => null],
            ['type_operation_id' => 3, 'operateur_id' => null, 'montant_min' => 10001, 'montant_max' => 50000,  'frais' => 300, 'actif' => 1, 'date_debut' => $now, 'date_fin' => null],
        ];
